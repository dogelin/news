            ...
            <form name="formlist" id="formlist" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/Admin/Content/add" id="addsubmit"><i class="icon-font"></i>新增新闻</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="95%" id="messagelst">
                        ...
                        <?php if(is_array($cons)): $i = 0; $__LIST__ = $cons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td ><a target="_blank" href="#" ><?php echo (catename($vo["cate_id"])); ?></a> 
                            </td>
                            <td ><?php echo (pic($vo["pic"])); ?></td>
                            <td class="status" onclick="editstatus(<?php echo ($vo["status"]); ?>,<?php echo ($vo["id"]); ?>)"><?php echo (statusname($vo["status"])); ?></td>
                            <td ><?php echo (strtime($vo["updatetime"])); ?></td>
                            
                            <td>
                                <a class="link-update" href="/index.php/Admin/Content/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                    ...
                    <br>
                    	...
                    	<?php if(is_array($locas)): $i = 0; $__LIST__ = $locas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><option value="<?php echo ($i["id"]); ?>"><?php echo ($i["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    	</select>
                    	&nbsp;<button type="button" class="btn btn-primary btn4 mr8" id="submit_loca">推送</button>
                    </div>
        </div>
    </div>
    <!--/main-->
...
<script type="text/javascript">
 var SCOPE={
		 post_url:"/index.php/Admin/Content/del",
		 post_dels:"/index.php/Admin/Content/dels",
		 post_order:"/index.php/Admin/Content/listorder",
		 jump_url:"/index.php/Admin/Content/lst",
		 status_url:"/index.php/Admin/Content/status",
		loca_url:'/index.php/Admin/Content/push',
 };
</script>
</body>
</html>