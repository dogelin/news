    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
            	...
            	<a class="crumb-name" href="#">站点管理</a>
            </div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>站点标题：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($basic["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>站点关键词：</th>
                                <td>
                                    <input class="common-text required" id="key" name="key" size="50" value="<?php echo ($basic["key"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>站点描述：</th>
                                <td>
                                    <textarea rows="5" cols="50" name="disc"><?php echo ($basic["disc"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    <button type="button" class="btn btn-primary btn6 mr10" id="submit_add">提交</button>
                                </td>
                            </tr>
                        </tbody></table>
                </form>
...
<script type="text/javascript">
	var SCOPE={
			'add_url': '/index.php/Admin/Basic/lst',
			'jump_url' :'/index.php/Admin/Basic/lst',
	};
</script>
</body>
</html>