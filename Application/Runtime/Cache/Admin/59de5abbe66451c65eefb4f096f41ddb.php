...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-name">推荐位管理</span></div>
        </div>
            ...
            <form name="formlist" id="formlist" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/Admin/Located/add" id="addsubmit"><i class="icon-font"></i>新增推荐位</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="95%" id="messagelst">
                        ...
                        <?php if(is_array($locas)): $i = 0; $__LIST__ = $locas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/index.php/Admin/Located/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
...
<script type="text/javascript">
 var SCOPE={
		 post_url:"/index.php/Admin/Located/del",
		 post_dels:"/index.php/Admin/Located/dels",
		 jump_url:"/index.php/Admin/Located/lst",
		 status_url:"/index.php/Admin/Located/status",
 };
</script>
</body>
</html>