...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <a class="crumb-name" href="/index.php/Admin/Located/lst">推荐位管理</a>
            <span class="crumb-step">&gt;</span><span>新增推荐位</span></div>
        </div>
            ...
            <div class="result-content">
                <form action="" method="post" id="editForm" name="editForm" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>推荐位名称：</th>
                                <td>
                                	<input type="hidden" value="<?php echo ($locas["id"]); ?>" name="id" id="id">
                                    <input class="common-text required" id="name" name="name" size="50" value="<?php echo ($locas["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
...
<script type="text/javascript">
	var SCOPE={
			'save_url': '/index.php/Admin/Located/edit/id/7',
