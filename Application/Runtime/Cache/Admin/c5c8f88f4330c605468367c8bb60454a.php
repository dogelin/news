...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <a class="crumb-name" href="/index.php/Admin/User/lst">管理员管理</a>
            <span class="crumb-step">&gt;</span>
            <span>修改管理员</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	<input type="hidden" value="<?php echo ($users["id"]); ?>" name="id" id="id">
...
<script type="text/javascript">
	var SCOPE={
			'save_url': '/index.php/Admin/User/edit/id/3',
