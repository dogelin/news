...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <a class="crumb-name" href="/index.php/Admin/Locamain/lst">推荐内容管理</a>
            <span class="crumb-step">&gt;</span><span>编辑推荐内容</span></div>
        </div>
            ...
            <div class="result-content">
                <form action="" method="post" id="editForm" name="editForm" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>推荐位：</th>
                                <td>
                                	<input type="hidden" value="<?php echo ($pushs["id"]); ?>" name="id" id="id">
                                    <select name="loca_id" id="loca_id">
                    					<?php if(is_array($locas)): $i = 0; $__LIST__ = $locas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><option value="<?php echo ($i["id"]); ?>" <?php if($i['id'] == $pushs['loca_id']): ?>selected="selected"<?php endif; ?> ><?php echo ($i["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    				</select>
                                </td>
                            </tr>
                            <tr>
...
<script type="text/javascript">
	var SCOPE={
			'save_url': '/index.php/Admin/Locamain/edit/id/70',
